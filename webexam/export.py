...
class Export():
        ...
        try:
            for _id in ids:
                ...
                for _sec in sections:
                    ...
                    export_subjects.extend(self.get_subject(
                        _sec_obj['libname'], _sec_obj['sectionname'], str(_sec_obj['id'])))
        ...
        try:
            for _id in ids:
                ...
                for obj in rows:
                    ...
                    #
                    section = json.loads(
                        Load('section').get(sub_obj['sectionid']))
    ...
    def export_to_xls(self, subjects):
        ...
        for subject in subjects:
            ws.write(index, 0, self.replace_subjecttype(
                subject['subjecttype']))
            ...
            ws.write(index, 5, self.replace_answer_text(
                subject['subjecttype'], subject['answer']))
            option_index = 6
    ...
    def replace_subjecttype(self, subjecttype):
        subjecttypes = {'Judge': u'判断题',
                        'SingleSel': u'单选题', 'MultiSel': u'多选题'}
