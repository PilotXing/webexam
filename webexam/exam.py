...
class Exam():
    ...
    def get_option_and_answer(self,subject):
        ...
        #answer
        # answer_inst = Answer.query.filter_by(subjectid == subject[id])
        answer_inst = List('answer')
        answer_inst.obj_instance['answer']['filter'] = "subjectid==%s"%subject['id']
        answer_obj = self.new_method(answer_inst)
    ...
    def new_method(self, answer_inst):
        print('='*100)
        print(answer_inst.gets(page=0))
